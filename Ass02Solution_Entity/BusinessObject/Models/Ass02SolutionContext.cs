...
{
    public partial class Ass02SolutionContext : DbContext
    {
        public Ass02SolutionContext()
        {
        }

        public Ass02SolutionContext(DbContextOptions<Ass02SolutionContext> options)
            : base(options)
        {
        }
